...
reset = "\033[0m"
aras1.arasDecinsta()
ID = input(f'{white}𝗜𝗗 ➛  {red} ')
token = input(f'{white}𝗧𝗢𝗞𝗘𝗡 ➛  {red} ')
webbrowser.open('')
aca = 0
total = 0
hits = 0
...
def pppp():
    ...
    output = (
        f"{red}======================================================================================================\n"
        f"{green} HIT: {white}{hits} | {magenta} Bad : {white}{badinsta} |  {cyan} Check: {white}{bademail} \n"        f"{M} تم الفك    • @ ¦ : @ "
        f"{white} {blue}{white} {white} {blue}"
        f" {red}======================================================================================================\n")
...
def check_gmail(email):
    ...
    try:
        ...
        response = pp(
            'https://accounts.google.com/_/signup/usernameavailability',            params=params,
            cookies=cookies,
            headers=headers,
            data=data,
        )
...
• قناة المفكك : @pytho2n'''
    ...
    with open('arasDecinsta.txt', 'a') as ff:
        ff.write(f'{ss}\n')
...
def arasDecW4_M4():
    while True:
        data = {
            ...
            "variables": json.dumps({"id": int(random.randrange(17699999,361365133)), "render_surface": "PROFILE"}),
